...
// bus.emit('users-added')

// bus.on('users-changed', () => {})
...
// iport it too after make f to sort this users
// const formattedUsers = users.map(() => 1)
